...
df_trips = spark.read.table("nyctaxi.02_silver.yellow_trips_cleansed").filter(f"tpep_pickup_datetime >= '{two_months_ago_start}'".format(two_months_ago_start))
df_trips.display()
...
df_result.write.mode("append").saveAsTable("nyctaxi.02_silver.yellow_trips_enriched")
...
spark.sql("create catalog if not exists nyctaxi managed location 'abfss://unity-catalog-storage@dbstoragetglytuj3ydso6.dfs.core.windows.net/7405612380895535'")
